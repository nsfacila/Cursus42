...
/*   Updated: 2024/06/11 22:46:43 by noelsanc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Usamos la funcion ft_putptr para imprimir un puntero. 
Usamos unsigned long long ya que un puntero ptr se convierte a un valor entero sin signo de 64 bits (unsigned long long). 
Esto es porque una dirección de memoria puede representarse como un entero grande, y unsigned long long es adecuado para almacenar direcciones en sistemas de 64 bits.
La función ft_putptr toma un argumento n que es un puntero y lo imprime en hexadecimal. 
